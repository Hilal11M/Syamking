...
logo = """                                
   ╲ ▁▂▂▂▁ ╱
      ...
      ▄██ ███ ██▄        vivo-2007
     ▄███████████▄       OS: Android 11
  ▄█ ▄▄▄▄▄▄▄▄▄▄▄▄▄ █▄    Device: vivo 2007 (1906)
  ██ █████████████ ██    ROM: RP1A.200720.012 release-keys
  ██ █████████████ ██    Baseband: msm
  ██ █████████████ ██    Kernel: aarch64 Linux 4.9.227-perf+
  ██ █████████████ ██    Uptime:
     █████████████       CPU: Qualcomm Technologies, Inc SDM439
      ███████████        GPU: Qualcomm Technologies, Inc SDM439
       ██     ██         RAM: 1879MiB / 2832MiB
       ██     ██
                                 
                                 
-----------------------------------------------
\033[1;93m AUTHOR: Lal  kimochi
\033[1;93m Facebook:Lal kimochi
\033[1;93m Fb Page:LAL
\033[1;91m-----------------------------------------------                           
...
def main_select():
    ...
    if Mz =="2":
        ...
        os.system("https://www.facebook.com/m.hilal.7370")
	...
	def main(arg):
		...
		try:
		    ...
		    if 'www.facebook.com' in d['error_msg']:
		        ...
		        print("\033[1;93m[LAL>CP] "+uid+" = "+pass1)
		    	...
		    	if "access_token" in d:
		            ...
		            if 'www.facebook.com' in d['error_msg']:
		                ...
		                print("\033[1;93m[LAL>CP] "+uid+" = "+pass2)
		                ...
		                if 'access_token' in d:
		                    ...
		                    if 'www.facebook.com' in d['error_msg']:
		                        ...
		                        print("\033[1;93m[LAL>CP] "+uid+" = "+pass3)
		                        ...
		                        if 'access_token' in d:
		                            ...
		                            if 'www.facebook.com' in d['error_msg']:
		                                ...
		                                print("\033[1;93m[LAL>CP] "+uid+" = "+pass4)
		                                ...
		                                if 'access_token' in d:
		                                    ...
		                                    if 'www.facebook.com' in d['error_msg']:
		                                        ...
		                                        print("\033[1;93m[LAL>CP] "+uid+" = "+pass5)
		                                        ...
		                                        if 'access_token' in d:
		                                            ...
		                                            if 'www.facebook.com' in d['error_msg']:
		                                                ...
		                                                print("\033[1;93m[LAL>CP] "+uid+" = "+pass6)
		                                                ...
		                                                if 'access_token' in d:
		                                                    ...
		                                                    if 'www.facebook.com' in d['error_msg']:
		                                                        ...
		                                                        print("\033[1;93m[LAL>CP] "+uid+" = "+pass7)
